...
This release is a read-only projection with Play/Pause/Seek/Loop UI. TemporalDocument, editing commands, selection mutation, Undo/Redo, Graph Editor, Rust crates, asset importers, audio/video decoding, and a Tauri adapter are intentionally out of scope.
